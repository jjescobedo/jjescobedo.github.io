  ...
  return (
    <div>
      ...
      <div>
        ...
        <p className="body-text-left-half">
        ...
        <p className="body-text-left-half">
        I've loved cooking since I was tall enough to reach over the stove. I love going out to eat new food and experimenting with different recipes. Every family member I have on my dad's side has been involved in the restaurant business or food product business at some point in their life and I've cooked alongside them many times. I use the skills I learned with my family on the DVCA campus by hosting pop-up taco stand fundraising events for the DVCA Latinos Unidos club.
        </p>
      </div>
      <div>
        <h2 className="page-header-right-2">Path to Da Vinci</h2>
        <p className="body-text-right-half">
